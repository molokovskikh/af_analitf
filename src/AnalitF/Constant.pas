...
const
  ...
  OrderJunkMessage = 'Вы заказали препарат с ограниченным сроком годности'#13#10' или с повреждением вторичной упаковки.';
  ...
  SelectedProductInAwaitedList = 'Выбранное наименование уже присутствует в списке ожидаемых позиций';
