...
DESCRIBE FIELD CALCULATELEADER TABLE CLIENTS
'Расчитывать ли лидеро при отправке заказов';

ALTER TABLE CORE ADD REGISTRYCOST NUMERIC(8,2);

DESCRIBE FIELD REGISTRYCOST TABLE CORE
'Цена реестра';

ALTER TABLE CORE ADD VITALLYIMPORTANT FB_BOOLEAN;

DESCRIBE FIELD VITALLYIMPORTANT TABLE CORE
'Жизненно-важный';

ALTER TABLE CORE ADD REQUESTRATIO INTEGER;

DESCRIBE FIELD REQUESTRATIO TABLE CORE
'Кратность заказа';
