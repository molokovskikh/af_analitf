...
type
  ...
  private
    ...
    // включить/ выключить скроллы в зависимости от объЄма текста
...
begin
  ...
  DM.adsPrices.Open;
  try
    //≈сли всего один прайс-лист, он в работе и кол-во позиций больше нул€
...
begin
	inherited;
  //–еализаци€ вз€та отсюда: http://www.autoaf.ru/faq_delphi.htm
...
begin
	lblPriceCount.Caption := '¬сего прайс-листов : ' + IntToStr( adsPrices.RecordCount);
end;
...
begin
  x := Length(Memo.Text);
  //  ол-во строк в Memo (не линий Lines)
