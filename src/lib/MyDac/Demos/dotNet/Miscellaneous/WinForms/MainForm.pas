...
uses
  ...
  DB, MyAccess, DBAccess, MyDacVcl, Devart.MyDac.DataAdapter;
...
type
  ...
  strict private
    ...
    MyDataAdapter1: Devart.MyDac.DataAdapter.MyDataAdapter;
...
begin
        ...
        Self.MyDataAdapter1 := Devart.MyDac.DataAdapter.MyDataAdapter.Create;
        ...
        // MyDataAdapter1
        // 
        Self.MyDataAdapter1.DataSet := nil;
        Self.MyDataAdapter1.Name := '';
        Self.MyDataAdapter1.Tag := nil;
        // 
        // btUpdate
        // 
        ...
        Self.Name := 'TMainForm';
        Self.Text := 'MyDac .NET demo - using DataSet component';
