...
function uncompress(dest: IntPtr; destlen: IntPtr; source: IntPtr; sourceLne: longint): longint; external;
{$ELSE}
var
  compress: function(dest: pointer; destLen: pointer; const source: pointer; sourceLen: longint): longint; cdecl;
  uncompress: function(dest: pointer; destlen: pointer; source: pointer; sourceLne: longint): longint; cdecl;
{$ENDIF}
{$ENDIF}
{$ENDIF}
