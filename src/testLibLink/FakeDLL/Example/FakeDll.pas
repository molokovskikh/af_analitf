...
begin
  ...
  MajVer    := $01;
  MinVer    := $01;
  Copyright := #13#10#13#10 + 'TFakeDll v1.1 (Beta 2) by Dr.Golova' + #13#10 +
                              '[mailto: dr_golova@pisem.net]' + #13#10#13#10;
end;
...
begin
  _DG_CallDllMain8(Pointer(FDHandle), DLL_PROCESS_DETACH);
